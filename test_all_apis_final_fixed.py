...
try:
    ...
    # Oddiy password hash funksiyasini yaratish (test uchun)
...
if __name__ == "__main__":
    ...
    print("✅ Barcha API endpointlari uchun kompleks testlar yaratildi!")
    print("🔧 Test fayllari: test_all_apis_final_fixed.py")
    print("📋 Testlar quyidagi kategoriyalarni qamrab oladi:")
    print("   • Authentication (ro'yxatdan o'tish, kirish, chiqish)")
    print("   • User Endpoints (profil, balans, sayohatlar)")
    print("   • Admin Endpoints (foydalanuvchilar, statistika, daromad)")
    print("   • Dispatcher Endpoints (buyurtmalar, depozitlar, bloklash)")
    print("   • Driver Endpoints (holat, sayohat qabul qilish)")
    print("")
    print("🚦 Testlarni ishga tushirish:")
    print("   pytest test_all_apis_final_fixed.py -v")
    print(f"Import xatoligi: {e}")
    print("Kerakli fayllar mavjudligini tekshiring...")
    sys.exit(1)
...
# Test data - Qisqa parollar (bcrypt uchun 72 baytdan kam)
TEST_USER = {
    "email": "test@example.com",
    "phone": "+998901234567",
    "full_name": "Test User",
